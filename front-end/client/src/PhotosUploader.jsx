      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              ...
              {link === addedPhotos[0] ? (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  ...
                  <path fillRule="evenodd"
                        ...
                        7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 
                        2.082-5.005Z"
                        clipRule="evenodd"
                  />
                </svg>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round"
                        ...
                        0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 
                        3.602a.563.563 0 0 0-.182.557l1.285 
                        5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 
                        0 0 0-.586 0L6.982 20.54a.562.562 0 0 
        ...
        <label className="h-32 cursor-pointer flex items-center gap-1 justify-center border bg-transparent rounded-2xl p-2 text-2xl text-gray-600">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <path strokeLinecap="round" strokeLinejoin="round"
                  d="M12 16.5V9.75m0 0 3 3m-3-3-3 
                  3M6.75 19.5a4.5 4.5 0 0 
                  1-1.41-8.775 5.25 5.25 0 0 
                  1 10.233-2.33 3 3 0 0 1 
                  3.758 3.848A3.752 3.752 0 0 1 18 19.5H6.75Z"
            />
          </svg>
          Upload
        </label>
